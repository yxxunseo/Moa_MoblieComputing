...
target_dir = "/Users/yxxunseo/Desktop/HBU/3/3-1/모바일컴퓨팅과응용/Moa_Project/app/src/main/res/drawable"
...
for filename, content in svgs.items():
    ...
    # run svg2vd
    vd_path = svg_path.replace(".svg", ".xml")
    subprocess.run(["svg2vd", svg_path, vd_path])
